const About = () => {
    return (
        <div className="min-h-fit container mx-auto pt-16">
            <h2 className="text-5xl font-semibold  mb-10 mx-2 md:mx-0">About Us</h2>
            <div className="flex gap-4 flex-col md:flex-row">
                <div className="basis-1/2 px-4 py-8 bg-white">
